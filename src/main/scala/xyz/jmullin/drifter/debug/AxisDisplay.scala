 ...
 */
class AxisDisplay(axisLength: Option[Float] = 100f, gridMin: Float = -10f, gridMax: Float = 10f, gridStep: Float = 1f) extends Entity3D {
  ...
  override fun render(implicit batch: ModelBatch, environment: Environment) {
